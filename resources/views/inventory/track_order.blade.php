        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <button type="button" class="btn btn-danger btn-block" onclick="hapus_terakhir()">Hapus Terakhir</button>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <button type="button" class="btn btn-info btn-block" onclick="tambah_order()">Tambah Order</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
